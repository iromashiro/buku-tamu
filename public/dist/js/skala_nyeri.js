// Initialization Area
var painArray = ["Tidak Nyeri", "Nyeri Ringan", "Nyeri Menganggu", "Nyeri Yang Menyusahkan", "Nyeri hebat", "Nyeri Sangat Hebat"];
var pain = {}
...
slider.oninput = function() {
    ...
    // Update the "nyeri_bantuan" input field with the pain level description
    var nyeriBantuanInput = document.getElementById("nyeri_bantuan");
    nyeriBantuanInput.value = pain[painLevel];

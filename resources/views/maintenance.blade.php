...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('frontend_css/img/logoicon.png') }}">
    <title>Dinsos Muara Enim</title>
        ...
        <div class="row" style="padding-top:50px;">
            <div class="col-md-6">
                <div class="error-template">
                    ...
                    <div>
                        <p>
                            Maaf, Kami sedang memperbaharui data PPKS untuk th 2023-2024
                        <p>
                            — Dinsos Kabupaten Muara Enim</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <defs>
                        <pattern id="pattern1" height="100%" width="100%" patternContentUnits="objectBoundingBox">
                            <image height="1" width="1" preserveAspectRatio="none"
                                xlink:href="https://www.marslab.com.my/wp-content/uploads/2019/05/server.png" />
                        </pattern>

                        <pattern id="pattern2" height="100%" width="100%" patternContentUnits="objectBoundingBox">
                            <image height="1" width="1" preserveAspectRatio="none"
                                xlink:href="https://image.freepik.com/free-vector/illustration-characters-fixing-cogwheel_53876-40796.jpg" />
                        </pattern>

                        <pattern id="pattern3" height="100%" width="100%" patternContentUnits="objectBoundingBox">
                            <image height="1" width="1" preserveAspectRatio="none"
                                xlink:href="https://image.freepik.com/free-vector/maintenance-background-design_1294-45.jpg?1" />
                        </pattern>

                        <pattern id="pattern4" height="100%" width="100%" patternContentUnits="objectBoundingBox">
                            <image height="1" width="1" preserveAspectRatio="none"
                                xlink:href="https://image.freepik.com/free-vector/software-developers-during-coding-composition-with-creative-decisions-algorithmic-complexity-documentation-by-programming-languages-isometric_1284-33290.jpg" />
                        </pattern>

                        <pattern id="pattern5" height="100%" width="100%" patternContentUnits="objectBoundingBox">
                            <image height="1" width="1" preserveAspectRatio="none"
                                xlink:href="https://image.freepik.com/free-vector/illustration-gear-icon_53876-44011.jpg" />
                        </pattern>
                    </defs>
